...
exports.updateAvatarUserService = void 0;
...
var UpdateAvatarUserService = /** @class */ (function () {
    function UpdateAvatarUserService() {
    }
    UpdateAvatarUserService.prototype.execute = function (_a) {
        var avatarFilename = _a.avatarFilename, id = _a.userId;
        return __awaiter(this, void 0, void 0, function () {
            var repository, user, userAvatarFilePath, userAvatarFileExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default(messages_1.errors.changeAvatarNoAuthenticate);
                        }
...
exports.updateAvatarUserService = new UpdateAvatarUserService;
